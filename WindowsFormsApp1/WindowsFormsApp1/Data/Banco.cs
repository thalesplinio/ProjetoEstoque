...
namespace WindowsFormsApp1
{
    internal class Banco
    {
        ...
        public static void AdicionarTipo(TipoProdutoModel tipo)
        {
            try
            {
                var conexaoPropria = ConexaoBanco();
        ...
        public static bool ExisteFornecedor(FornecedorModel fornecedor)
        {
            bool res;
            SQLiteDataAdapter dataAdapter = null;   // Consulta - comando sql, conexao banco
            DataTable dataTable = new DataTable();  // preenche com as informações da consulta
        ...
        public static void NovoFornecedor(FornecedorModel fornecedor)
        {
        ...
        public static void AtualizarFornecedor(FornecedorModel fornecedor)
        {
            DateTime data = DateTime.Now;
            var dataFormatada = $"{data:yyyy-MM-dd HH:mm:ss}";
        ...
        public static void AdicionarProduto(ProdutosModel produtos)
        {
            try
            {
                DateTime data = DateTime.Now;
        ...
        public static DataTable ObterProdutosParaRetirar(ProdutosModel produto)
        {
            SQLiteDataAdapter dataAdapter = null;   // Consulta - comando sql, conexao banco
            DataTable dataTable = new DataTable();  // preenche com as informações da consulta
        ...
        public static void AtualizarProdutoEstoque(ProdutosModel produtos, int quantidade)
        {
            try
            {
                DateTime data = DateTime.Now;
        ...
        public static void AtualizarGerenciaProdutos(ProdutosModel produtos)
        {
            DateTime data = DateTime.Now;
            var dataFormatada = $"{data:yyyy-MM-dd HH:mm:ss}";
